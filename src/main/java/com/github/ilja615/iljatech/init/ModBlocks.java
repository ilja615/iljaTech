...
public class ModBlocks {
    ...
    public static final Block ALUMINIUM_ORE = registerWithItem("aluminium_ore", new ExperienceDroppingBlock(ConstantIntProvider.create(0), AbstractBlock.Settings.copy(Blocks.GOLD_ORE)));
    ...
    public static final Block DEEPSLATE_ALUMINIUM_ORE = registerWithItem("deepslate_aluminium_ore", new ExperienceDroppingBlock(ConstantIntProvider.create(0), AbstractBlock.Settings.copy(Blocks.DEEPSLATE_GOLD_ORE)));
