...
public enum WindDirection implements StringIdentifiable {
    ...
    NE("ne", new Vec2f(1.41421356237f, -1.41421356237f), new Direction[]{Direction.NORTH, Direction.EAST}),
    E("e", new Vec2f(1, 0), new Direction[]{Direction.EAST}),
    SE("se", new Vec2f(1.41421356237f, 1.41421356237f), new Direction[]{Direction.SOUTH, Direction.EAST}),
    S("s", new Vec2f(0, 1),new Direction[]{Direction.SOUTH}),
    SW("sw", new Vec2f(-1.41421356237f, 1.41421356237f), new Direction[]{Direction.SOUTH, Direction.WEST}),
    W("w", new Vec2f(-1, 0),new Direction[]{Direction.WEST}),
    NW("nw", new Vec2f(-1.41421356237f, -1.41421356237f), new Direction[]{Direction.NORTH, Direction.WEST});
