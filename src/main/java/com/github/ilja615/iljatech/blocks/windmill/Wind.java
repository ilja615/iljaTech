...
public class Wind {
    ...
    public static Pair<WindDirection, Double> getWindFromVector(Vector2f vector) {
    ...
    public static Vector2f getWindDirectionUnitVectorAt(World world, int chunkX, int chunkZ) {
        if (world != null && world instanceof ServerWorld serverWorld)
            seed = serverWorld.getSeed();
