...
import com.github.ilja615.iljatech.datagen.book.iljatech.PyroMetallurgyCategory;
...
public class IljaTechBook extends SingleBookSubProvider {
    ...
    protected void generateCategories() {
        ...
        var pyroMetallurgyCategory = this.add(new PyroMetallurgyCategory(this).generate());
    }
