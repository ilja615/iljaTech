...
public class ModEnglishTranslationProvider extends AbstractModonomiconLanguageProvider {
    ...
    protected void addMiscTranslations(){
        ...
        this.add("block.iljatech.nailed_acacia_planks", "Nailed Acacia Boards");
        this.add("block.iljatech.nailed_bamboo_planks", "Nailed Bamboo Boards");
        this.add("block.iljatech.nailed_birch_planks", "Nailed Birch Boards");
        this.add("block.iljatech.nailed_cherry_planks", "Nailed Cherry Boards");
        this.add("block.iljatech.nailed_crimson_planks", "Nailed Crimson Boards");
        this.add("block.iljatech.nailed_dark_oak_planks", "Nailed Dark Oak Boards");
        this.add("block.iljatech.nailed_jungle_planks", "Nailed Jungle Boards");
        this.add("block.iljatech.nailed_mangrove_planks", "Nailed Mangrove Boards");
        this.add("block.iljatech.nailed_oak_planks", "Nailed Oak Boards");
        this.add("block.iljatech.nailed_spruce_planks", "Nailed Spruce Boards");
        this.add("block.iljatech.nailed_warped_planks", "Nailed Warped Boards");
        ...
        this.add("block.iljatech.chair", "Chair");
