...
public class FireBoxEntry extends EntryProvider {
    public static final String ID = "firebox";

    public FireBoxEntry(CategoryProvider parent) {
        super(parent);
    }
